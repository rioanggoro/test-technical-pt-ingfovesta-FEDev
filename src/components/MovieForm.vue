        ...
        <div class="flex items-center justify-between">
          ...
          <div class="flex gap-2">
            <button
              ...
              @click="handleDelete"
              :disabled="isLoading"
              class="w-12 h-12 bg-red-600 hover:bg-red-700 disabled:bg-red-400 text-white rounded-lg font-bold text-lg transition-colors flex items-center justify-center"
              title="Delete Movie"
            >
              D
            </button>
            <button
              ...
              class="w-12 h-12 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white rounded-lg font-bold text-lg transition-colors flex items-center justify-center"
              title="Save Movie"
            >
              <span v-if="isLoading">
                <svg
        ...
        <div class="space-y-6">
          <div>
            ...
            <p class="mt-1 text-xs text-gray-500">
              {{ movieForm.title.length }}/{{ VALIDATION.TITLE_MAX_LENGTH }}
              characters
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p class="mt-1 text-xs text-gray-500">
              {{ movieForm.summary.length }}/{{ VALIDATION.SUMMARY_MAX_LENGTH }}
              characters
            </p>
          </div>
